...
$config->story->create->requiredFields = 'title,devTeam';
...
$config->story->list->customBatchCreateFields = 'module,spec,source,verify,pri,estimate,keywords';
$config->story->custom->batchCreateFields = 'module,spec,pri,estimate';
